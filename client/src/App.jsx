        ...
        {(permissions) => {
            ...
            return (
                <>
                    ...
                    {(isAbsenceType(permissions) || isAdmin(permissions)) && (
                        <Resource
                            name="absence_type"
                            {...absenceType}
                            options={{ menuGroup: 'data' }}
                    ...
                    <Resource
                        name="att_report_with_report_month"
                        {...attReportWithReportMonth}
                        options={{ menuGroup: 'data' }}
                        icon={ViewListIcon}
                    />
                    ...
                    />
                    <Resource
                        name="student_klass_report"
                        {...studentKlassesReport}
                        options={{ menuGroup: 'report' }}
                        icon={GroupWorkIcon}
                    />
                    <Resource
                        name="teacher_report_status"
                        {...teacherReportStatus}
                        options={{ menuGroup: 'report' }}
                        icon={RuleIcon}
                    />
                    ...
                    {isAdmin(permissions) && (
                        <Resource
                            name="student_percent_report"
                            {...studentPercentReport}
                            options={{ menuGroup: 'report' }}
                            icon={SummarizeIcon}
                        />
                    )}
                    ...
                    />
                    <Resource
                        name="grade_effect_by_user"
                        {...(isAdmin(permissions) ? resourceEntityGuesser : {})}
                        recordRepresentation={'effect'}
                        options={{ menuGroup: 'admin' }}
                        icon={AdminPanelSettingsIcon}
                    />
                    <Resource
                        name="abs_count_effect_by_user"
                        {...(isAdmin(permissions) ? resourceEntityGuesser : {})}
                        recordRepresentation={'effect'}
                        options={{ menuGroup: 'admin' }}
                        icon={AdminPanelSettingsIcon}
                    ...
                    {isLessonSignature(permissions) && (
                        <>
                            <Resource
                                ...
                                {...reportGroup}
                                create={null}
                                edit={isAdmin(permissions) ? reportGroup.edit : null}
                                options={{ menuGroup: 'settings' }}
                                icon={GroupWorkIcon}
                            />
                            <Resource
                                name="report_group_session"
                                {...reportGroupSession}
                                options={{ menuGroup: 'settings' }}
                                icon={DateRangeIcon}
                            />
