  ...
  >
    {permissions => {
      ...
      const adminResources = [
        ...
        p => isAdmin(p) && { name: 'student_percent_report', config: studentPercentReport, icon: SummarizeIcon, menuGroup: 'report' },
        { name: 'report_month', config: reportMonth, icon: DateRangeIcon, menuGroup: 'settings' },
        p => isUploadedFiles(p) && { name: 'uploaded_file', config: uploadedFile, icon: UploadFileIcon, menuGroup: 'settings' },
