...
export class updateStudentKlassReportAddKlassReferenceIdColumns1696879784006 implements MigrationInterface {
    name = 'updateStudentKlassReportAddKlassReferenceIdColumns1696879784006'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            CREATE INDEX \`klass_types_klassTypeEnum_idx\` ON \`klass_types\` (\`klassTypeEnum\`)
        `);
        await queryRunner.query(`
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            DROP INDEX \`klass_types_klassTypeEnum_idx\` ON \`klass_types\`
        `);
        await queryRunner.query(`
            CREATE VIEW \`student_klasses_report\` AS
            SELECT \`student_klasses\`.\`year\` AS \`year\`,
