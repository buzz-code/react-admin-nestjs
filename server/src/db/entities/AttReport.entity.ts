...
@Index(
  'att_user_sheet_name_lession_klass_year_idx',
  ['userId', 'sheetName', 'lessonReferenceId', 'klassReferenceId', 'year'],
  {},
)
...
@Index(
  'att_user_year_student_teacher_klass_lesson_idx',
  ['userId', 'year', 'studentReferenceId', 'teacherReferenceId', 'klassReferenceId', 'lessonReferenceId'],
  {},
)
