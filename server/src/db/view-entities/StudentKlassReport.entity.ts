    ...
    dataSource
      ...
      .addSelect(
        getGroupConcatExpression(
          `if(klass_types.klassTypeEnum = '${KlassTypeEnum.baseKlass}', student_klasses.klassReferenceId, null)`,
          ',',
          false,
        ),
        'klassReferenceId_1',
      ...
      .addSelect(
        getGroupConcatExpression(
          `if(klass_types.klassTypeEnum = '${KlassTypeEnum.track}', student_klasses.klassReferenceId, null)`,
          ',',
          false,
        ),
        'klassReferenceId_2',
      ...
      .addSelect(
        getGroupConcatExpression(
          `if(klass_types.klassTypeEnum = '${KlassTypeEnum.speciality}', student_klasses.klassReferenceId, null)`,
          ',',
          false,
        ),
        'klassReferenceId_3',
      ...
      .addSelect(
        getGroupConcatExpression(
          `if(klass_types.klassTypeEnum = '${KlassTypeEnum.other}' || klass_types.klassTypeEnum is null, student_klasses.klassReferenceId, null)`,
          ',',
          false,
        ),
        'klassReferenceId_null',
      )

      .addSelect(
        getGroupConcatExpression(
          `if(klass_types.klassTypeEnum = '${KlassTypeEnum.baseKlass}', klasses.name, null)`,
          ', ',
          false,
        ),
        'klass_name_1',
      ...
      .addSelect(
        getGroupConcatExpression(
          `if(klass_types.klassTypeEnum = '${KlassTypeEnum.track}', klasses.name, null)`,
          ', ',
          false,
        ),
        'klass_name_2',
      ...
      .addSelect(
        getGroupConcatExpression(
          `if(klass_types.klassTypeEnum = '${KlassTypeEnum.speciality}', klasses.name, null)`,
          ', ',
          false,
        ),
        'klass_name_3',
      ...
      .addSelect(
        getGroupConcatExpression(
          `if(klass_types.klassTypeEnum = '${KlassTypeEnum.other}' || klass_types.klassTypeEnum is null, klasses.name, null)`,
          ', ',
          false,
        ),
        'klass_name_null',
