...
@ViewEntity('student_global_report', {
  expression: (dataSource: DataSource) =>
    dataSource
      .createQueryBuilder()
      .select(
        'CONCAT(COALESCE(sgr_inner.studentReferenceId, "null"), "_", COALESCE(sgr_inner.teacherReferenceId, "null"), "_", ' +
          'COALESCE(sgr_inner.klassReferenceId, "null"), "_", COALESCE(sgr_inner.lessonReferenceId, "null"), "_", ' +
          'COALESCE(sgr_inner.user_id, "null"), "_", COALESCE(sgr_inner.year, "null"))',
        'id',
      )
      ...
      .from(
        (subQuery) =>
          subQuery
            ...
            .addGroupBy('atag.lessonReferenceId'),
        'sgr_inner',
      )
