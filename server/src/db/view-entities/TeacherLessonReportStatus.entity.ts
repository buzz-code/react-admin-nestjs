  ...
  expression: (dataSource: DataSource) =>
    dataSource
      ...
      .leftJoin(
        ReportMonth,
        'report_months',
        'report_months.userId = lessons.userId AND report_months.year = lessons.year',
      )
      .leftJoin(
        AttReport,
        'att_reports',
        'att_reports.teacherReferenceId = lessons.teacherReferenceId AND att_reports.lessonReferenceId = lessons.id AND att_reports.report_date BETWEEN report_months.startDate AND report_months.endDate',
      )
