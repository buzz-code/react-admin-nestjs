...
(1675356165986, 'KlassAddReferenceId'),
(1675366584689, 'KlassAddKlassTypeReferenceId'),
(1676234639701, 'addManyReferenceId'),
(1676319747789, 'addAuditLog'),
(1676373585567, 'updateStudentBaseKlass'),
(1676973723497, 'addImportFileTable'),
(1679387546635, 'fixLessonReferenceId'),
(1679433140359, 'addMailAddressTable'),
(1679606124656, 'addHandleEmailData'),
(1679607283312, 'updateHandleEmailData'),
(1681588431337, 'recievedMailNullableColumns'),
(1682255853138, 'addUserInfoColumn'),
(1682613070027, 'fixKlassType'),
(1682885643767, 'updateNullableFields'),
(1682967271092, 'updateDateFields'),
(1682968919553, 'addPageTable'),
(1683142771777, 'removePathAddOrderPagesTable'),
(1683527164577, 'rerunReferenceIdForProd'),
(1684139644957, 'addReportMonthsTable'),
(1684164901088, 'createTeacherReportStatusViews'),
(1684165648031, 'addIdToTeacherReportStatusView'),
(1684165883070, 'updateIdToTeacherReportStatusView'),
(1684219765661, 'addJoinsToTeacherReportStatus'),
(1684223659058, 'addKlassReferenceIdForLessons'),
(1684406609710, 'updateStudentKlassReeportReference'),
(1684407026417, 'updateStudentKlassReeportJoinStudents'),
(1684693416581, 'addUserPaymentInfo'),
(1684694518104, 'addUserSendMailFromInfo'),
(1684842208464, 'addTextByUserView'),
(1684852538625, 'addUserIdToTextByUserView'),
(1686680413320, 'updateStudentBaseKlassReportJoinConditions'),
(1686757018415, 'addAttReportAndGradeView'),
(1686757929196, 'addStudentGlobalReportView'),
(1686758604957, 'fixStudentGlobalReportView'),
(1686766165368, 'addStudentPercentReportView'),
(1686766691647, 'changeStudentPercentReportViewUpdatePercentCalc'),
(1686766743345, 'changeStudentPercentReportViewUpdateGradeCalc'),
(1687115195304, 'addYearToTeacherStatusReports'),
(1687171083496, 'fillCurrentYearOnTables'),
(1688581442248, 'updateStudentGlobalReportFixIdOnNull'),
(1689189688623, 'updateStudentsAddCommentColumn'),
(1689619350360, 'updateTeacherLessonReportStatusViewAddLessonConditions'),
(1689856702136, 'addImageTable'),
(1693688366912, 'addStudentByYearView'),
(1693721982777, 'updateStudentByYearYearColumn'),
(1693827099474, 'addPaymentTrackTable'),
(1694374542167, 'addCommentToLessons'),
(1694450301604, 'addTeacherInKlassTypeTable'),
(1695290797452, 'updateYemotCallIncreaseHistoryLength'),
(1695364381711, 'addIndexesForYemotCall'),
(1696873095052, 'addTeacherSalaryReportView'),
(1696873773338, 'updateTeacherSalaryReportView'),
(1696875067298, 'updateViewsIds'),
(1696875184214, 'updateViewsIdsAgain'),
(1696879784006, 'updateStudentKlassReportAddKlassReferenceIdColumns'),
(1696879935960, 'updateStudentKlassReportUpdateKlassReferenceIdColumns'),
(1698175230064, 'updateTeacherReportStatusViewIdToIncludeYear'),
(1698308766347, 'updateTeacherReportStatusViewAddLessonNameColumns'),
(1698309566758, 'createAttReportWithReportMonthView'),
(1698309810693, 'updateTeacherSalaryReportToUseAttReportWithReportMonth'),
(1698310278655, 'updateTeacherLessonReportStatusToUseAttReportWithReportMonth'),
(1698310976879, 'cosmeticChangesToViews'),
(1698650715375, 'schemantics'),
(1698650838088, 'updateStudentByYearToIncludeKlassIds'),
(1698775162074, 'cosmeticChangesToViews'),
(1698775288010, 'addSemesterToReportMonth'),
(1698821603832, 'adColumnsToKnownAbsences'),
(1698822192680, 'addKnownAbsenceWithReportMonthView'),
(1699903001380, 'addKlassTypeReferenceIDsToStudentByYearView'),
(1700683658614, 'makeAttReportAbsDecimal'),
(1701162232786, 'removeTzFromStudentBaseKlassView'),
(1701795323207, 'addIndexesToOptimizeTeacherReport'),
(1702474127872, 'makeIsBaseKlassToStudentGlobalReport'),
(1702580912725, 'addGradeNameAndAttGradeEffect'),
(1702802919133, 'simplifyStudentKlassReportViewJoins'),
(1703363342429, 'addEstimationToGrades'),
(1704207273135, 'addDefaultYearToKnownAbsences'),
(1705432003726, 'addTeacherGradeReportFileViews'),
(1705609443991, 'addNumbersTable'),
(1705777705679, 'adGradeEffectByUserView'),
(1705938484628, 'addAbsCountEffectByUserView'),
...
(1708547635746, 'optimizeStudentBaseKlass'),
(1708945273022, 'renameAllIndexes'),
(1711026137081, 'makeLessonsColumnFloat'),
(1723317958090, 'updateStudentsAddPhoneAndAddress'),
(1723482751870, 'updateStudentKlassesReportAddStudentDetails'),
(1727203045203, 'addYearToReportMonth'),
(1727206071127, 'filterTeacherReportStatusByYear'),
(1727331114248, 'addIsRevertedToAuditLog'),
(1732025737420, 'addImportFileTable'),
(1733151063542, 'addLessonKlassNameView'),
(1734522156070, 'addTeacherDisplayName'),
(1736169980504, 'addHowManyLessonsToLesson'),
(1737837325989, 'addStudentSpecialityView'),
(1742452916412, 'addDisplayNameToLessonAndKlass'),
(1742461073150, 'addOrderToLessons'),
(1743061002171, 'updateDisplayNameNullable'),
(1748362072638, 'UpdateTablesAndViews'),
(1748362190659, 'AddAttendanceNameTable'),
(1749152815025, 'AddIsActiveToStudent'),
(1749155415113, 'AddIsActiveToStudentByYear'),
(1750016064850, 'UpdateGradeEffectViews'),
(1753703108793, 'updateGradeEffectViews'),
(1753706287556, 'updateGradeEffectViewsEffectNumeric'),
(1757191402580, 'UpdateStudentKlassReportViewAddStudentReferenceId'),
(1757865082803, 'AddFilePathToText'),
(1759248397724, 'AddMetadataToImportFile'),
(1761669384732, 'UpdateLessonTimeToStartTime'),
(1762113630653, 'AddReportGroups'),
(1762116200000, 'MigrateExistingReportsToGroups'),
(1762188353979, 'removeReportGroupFromImportFile'),
(1762278302946, 'AddUserIdToReportGroupSession'),
(1762282737170, 'recreateAttReportWithReportMonth'),
(1762283756079, 'regenerateReportGroupSessions'),
(1763834256494, 'optimizeLessonKlassNameView'),
(1763931783912, 'OptimizeLessonKlassJoin'),
(1763933862682, 'OptimizeLessonKlassJsonTable');
